...
public class RedisService {
    ...
    /**
     * HashSet HMSET key field1 value1 [field2 value2 ] 同时将多个 field-value
     * (域-值)对设置到哈希表 key 中。 hmset 键 key value key value
     *
     * @param key
     *            键
     * @param map
    ...
    /**
     * HashSet 并设置时间 HMSET key field1 value1 [field2 value2 ] 同时将多个 field-value
     * (域-值)对设置到哈希表 key 中。
     *
     * @param key
     *            键
    ...
    /**
     * 向一张hash表中放入数据,如果不存在将创建 hset key item value 修改某个对象的属性，如果不存在，创建
     *
     * @param key
     *            键
     * @param item
    ...
    /**
     * 删除hash表中的值 HDEL key field1 [field2] 删除一个或多个哈希表字段
     *
     * @param key
     *            键 不能为null
     * @param item
